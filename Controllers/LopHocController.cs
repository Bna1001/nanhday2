...
namespace nanh1111kiemtra.Controllers
{
    public class LopHocController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaLop,TenLop,SoPhong")] LopHoc lopHoc)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaLop,TenLop,SoPhong")] LopHoc lopHoc)
        {
            if (id != lopHoc.MaLop)
            {
                return NotFound();
